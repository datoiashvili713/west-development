...
function Header() {
  return (
    <header className="flex justify-center items-center w-full py-6 px-[5%] bg-slate-600">
      <div className="flex md:flex-col justify-between items-center lg:flex-row w-full gap-2">
        ...
        <Image
          ...
          className="md:hidden"
        />
        <div className="hidden md:flex gap-8 text-lg text-white justify-center items-center">
          <p>კონტაქტი</p>
